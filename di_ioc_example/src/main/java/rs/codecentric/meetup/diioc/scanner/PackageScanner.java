...
public class PackageScanner {
    ...
    public List<Class> findAnnotatedClasses(String packageName, Class annotation) throws Exception {
    ...
    protected List<Class> getClasses(String packageName) throws ClassNotFoundException, IOException {
